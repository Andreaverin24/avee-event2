...
export function RecoveryStack({
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-[1.8rem] border border-white/10 bg-slate-950/55 p-5 backdrop-blur-xl">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        {streams.map((stream) => (
          <div
            key={stream.label}
            className="rounded-[1.7rem] border border-white/10 bg-slate-950/55 p-5 backdrop-blur-xl"
          >
