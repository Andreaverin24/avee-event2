...
const FullscreenSlide = forwardRef<HTMLElement, FullscreenSlideProps>(
  ({ kicker, title, summary, index, total, children }, ref) => {
    return (
      <section
        ref={ref}
        className="relative flex min-h-screen snap-start items-stretch px-4 py-5 md:px-8 md:py-7"
      >
        ...
        <motion.div
          ...
          className="glass-panel grid-line relative flex w-full flex-col overflow-hidden rounded-[2rem] p-6 pb-28 md:rounded-[2.5rem] md:p-10 md:pb-24"
        >
          <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
            <div className="max-w-4xl">
              <div className="eyebrow">{kicker}</div>
              <h2 className="mt-3 max-w-5xl text-3xl font-semibold leading-tight text-white md:text-5xl">
                <RichText text={title} />
              </h2>
